    ...
    <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
            <div class="col-md-10 text-center" data-aos="fade">
                <h1 class="heading mb-3">Review Write</h1>
            </div>
        </div>
    </div>
...
<section class="section contact-section" id="next">
	<div class="container">
		<div class="row">
            ...
            <div class="col-md-7">
            	<form action="/project1/reserveReviewEnd.p1" method="post" name="reveiwFrm" class="bg-white p-md-5 p-4 mb-5 border" enctype="multipart/form-data">
            		...
            		<input type="hidden" name="reserveidx" value="${reserveVO.roomidx}">
            		
            		<div class="row">
						<div class="col-md-12 form-group">
			            	<span class="text-black font-weight-bold" >숙박이 어땠나요?</span> &nbsp;&nbsp;
			                <span class="star">
								<span class="input" style="margin-top: 5px;">
									...
									<input type="radio" name="star" id="p10" value="5" checked><label for="p10">5</label>
								</span>
							</span>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 form-group">
            				<button class="btn btn-primary btn-block text-white" onClick="goReviewEnd();">리뷰 작성완료</button>
            			</div>
            		</div>
            	</form>
